    ...
    <>
     <div className="navbar bg-base-100 bg-primary">
        <div className="flex-1">
          <a className="btn btn-ghost text-xl">Decentralized Certificate Storage Application</a>
        </div>
      ...
      <div class="relative flex flex-col justify-center h-screen overflow-hidden">
        <div class="w-full p-6 m-auto bg-white rounded-md shadow-md lg:max-w-lg">
          <h1 class="text-3xl font-semibold text-center text-purple-700">Login PSU Passport</h1>
          <form class="space-y-4">
            <div>
              <label class="label">
                <span class="text-base label-text">Account Name</span>
              </label>
              <input type="text" placeholder="Account Name" class="w-full input input-bordered input-primary" />
            </div>
            <div>
              <label class="label">
            ...
            <div>
              <button class="btn btn-primary" href="/page/upload" onClick={handleLogin}>Login</button>
            </div>
