    ...
    <>
      <div className="navbar bg-base-100 bg-primary">
        ...
        <div className="flex-none">
          <button className="btn btn-square btn-ghost" aria-label="Notification">
      ...
      <div className="relative flex flex-col justify-center h-screen overflow-hidden">
        <div className="w-full p-6 m-auto bg-white rounded-md shadow-md lg:max-w-lg">
          ...
          <div className="my-6 space-y-2">
            ...
            <button aria-label="Login with GitHub" type="button" className="flex items-center justify-center w-full p-2 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-gray-400" onClick={handleLogin}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
